...
public class UserMovieListBeans implements Serializable {
	...
	public String getMovieThnmbnail() {
		return movieThnmbnail;
	}
	public void setMovieThnmbnail(String movieThnmbnail) {
		this.movieThnmbnail = movieThnmbnail;
	}
